...
import org.example.TareaService;
...
public class Menu {
    ...
    public void iniciar() {
        ...
        do {
            ...
            System.out.println("6. Buscar por asignatura");
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    for (Tarea t : service.listarTareas()) {
                        ...
                        if (t instanceof TareaUrgente) {
                            TareaUrgente tu = (TareaUrgente) t;
                            System.out.println(
                                    t.getId() + " | " +
                                            t.getAsignatura() + " | " +
                                            t.getDescripcion() + " | " +
                                            estado + " | PRIORIDAD: " + tu.getPrioridad()
                            );
                        } else {
                            System.out.println(
                                    t.getId() + " | " +
                ...
                case 6:
                    ...
                    for (Tarea t : service.buscar(buscar)) {
                        System.out.println(
                                t.getId() + " | " +
                                        t.getAsignatura() + " | " +
                                        t.getDescripcion()
